...
/*Basikes pra3eis pou orizontai gia thn oura kai merikes kainoyries apaitoumenes apo thn ergasia*/
...
{
        return oura.metritis;	/*Epistrefei sthn ousia to size(plh8os pelatwn) ths oyras*/
}
